...
#  Neo4jGraph object is a LangChain wrapper that allows LLMs to execute queries on a Neo4j instance
graph = Neo4jGraph(
...
graph.refresh_schema()  # sync any recent changes to your instance.
...
# prompt template for the question-answer component of the chain. This template tells the LLM to use the Cypher
# query results to generate a nicely-formatted answer to the user’s query
...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    ...
    validate_cypher=True, # If true, the Cypher query will be inspected for errors and corrected before running. Note
    # that this doesn’t guarantee the Cypher query will be valid. Instead, it corrects simple syntax errors that are
    # easily detectable
    top_k=100,
)