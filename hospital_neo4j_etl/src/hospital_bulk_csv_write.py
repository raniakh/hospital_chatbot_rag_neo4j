...
# basic configuration for the logging module. logging.INFO = Confirmation that things are working as expected.
logging.basicConfig(
    level=logging.INFO,
...
# instantiate a driver that connects to the Neo4j instance and set uniqueness constraints for each hospital system node.
